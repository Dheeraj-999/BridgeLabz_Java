/*
 * Problem 5- GCR Java strings Level 1
 ...
 * Write the Method to demonstrate StringIndexOutOfBoundsException. Access the
 * index using charAt() beyond the length of the String. Then write try catch
 * block for Exception while accessing the String method
...
public class stringIndexOutOfBoundsException {
    ...
    public static void handleException(String text) {
        try {
            System.out.println(text.charAt(text.length())); // try n catch
    ...
    public static void main(String[] args) {
        ...
        handleException(text); // handle the exception
